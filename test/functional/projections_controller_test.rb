...
class ProjectionsControllerTest < ActionController::TestCase
  ...
  test "should create projection" do
    assert_difference('Projection.count') do
      post :create, projection: { amount: @projection.amount, period: @projection.period, sub_account_id: @projection.sub_account_id, success: @projection.success }
    end
  ...
  test "should update projection" do
    put :update, id: @projection, projection: { amount: @projection.amount, period: @projection.period, sub_account_id: @projection.sub_account_id, success: @projection.success }
    assert_redirected_to projection_path(assigns(:projection))
  end
